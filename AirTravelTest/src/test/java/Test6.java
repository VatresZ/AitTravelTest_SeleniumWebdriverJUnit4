...
// OneWay is click
	...
	@Test
	// 6.KOREKTAN UNOS GRADA ZA POLAZAK I ZA DOLAZAK. KOREKTAK UNOS DATUMA POLASKA I clik na Search
	// Expeted:Available flights.
...
//		unos mesta dolaska
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.className("select2-result-label"))).click();   	                                                    		
//		unos datuma polaska-sutrasnji datum
